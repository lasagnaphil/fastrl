...
inline void Event::unsafe_arena_set_allocated_file_version(std::string* file_version) {
  ...
  if (file_version) {
    set_has_file_version();
    what_.file_version_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), file_version, GetArena());
  }
...
inline void Event::unsafe_arena_set_allocated_graph_def(std::string* graph_def) {
  ...
  if (graph_def) {
    set_has_graph_def();
    what_.graph_def_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), graph_def, GetArena());
  }
...
inline ::tensorflow::LogMessage* Event::_internal_mutable_log_message() {
  if (!_internal_has_log_message()) {
    clear_what();
    set_has_log_message();
    what_.log_message_ = CreateMaybeMessage< ::tensorflow::LogMessage >(GetArena());
  }
...
inline ::tensorflow::SessionLog* Event::_internal_mutable_session_log() {
  if (!_internal_has_session_log()) {
    clear_what();
    set_has_session_log();
    what_.session_log_ = CreateMaybeMessage< ::tensorflow::SessionLog >(GetArena());
  }
...
inline ::tensorflow::TaggedRunMetadata* Event::_internal_mutable_tagged_run_metadata() {
  if (!_internal_has_tagged_run_metadata()) {
    clear_what();
    set_has_tagged_run_metadata();
    what_.tagged_run_metadata_ = CreateMaybeMessage< ::tensorflow::TaggedRunMetadata >(GetArena());
  }
...
inline void Event::unsafe_arena_set_allocated_meta_graph_def(std::string* meta_graph_def) {
  ...
  if (meta_graph_def) {
    set_has_meta_graph_def();
    what_.meta_graph_def_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), meta_graph_def, GetArena());
  }
...
inline ::tensorflow::WatchdogConfig* WorkerHeartbeatRequest::_internal_mutable_watchdog_config() {
  ...
  if (watchdog_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::WatchdogConfig>(GetArena());
    watchdog_config_ = p;
  }
...
inline ::tensorflow::RequestedExitCode* WorkerHeartbeatRequest::_internal_mutable_exit_code() {
  ...
  if (exit_code_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::RequestedExitCode>(GetArena());
    exit_code_ = p;
  }
  return exit_code_;
}
